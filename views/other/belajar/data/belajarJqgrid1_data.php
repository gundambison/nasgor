<?php 
/****
	views	: belajar/data/belajarJqgrid1_data
	created	: 20-11-2015 14:27:41
	By		: Gunawan Wibisono
...
$id=dbIdReport('id','mujur_gundam list',json_encode($get)); 
...
if($get['_search']==='false'){	
	...
	$SQL = "SELECT gun_id id  FROM ".$this->$module->table." a  
	ORDER BY $sidx $sord 
	LIMIT $start , $limit"; 
	...
	foreach ($result->result_array() as $row){
		...
		$responce->rows[$i]['cell']=array($row['id'],$row2['code'],
