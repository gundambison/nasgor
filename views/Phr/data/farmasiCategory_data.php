<?php 
	/****
		views	: Phr/data/farmasiCategory_data
...
$id=dbIdReport('id','farmasi_category list',json_encode($get)); 
...
if($get['_search']==='false'){	
	...
	$SQL = "SELECT cat_id id  FROM ".$this->$module->table." a  
	ORDER BY $sidx $sord 
	LIMIT $start , $limit"; 
	...
	foreach ($result->result_array() as $row){
		...
		$responce->rows[$i]['cell']=array( $row2['code'],
		$row2['name'], $row2['pos']);
		$i++; 
		$responce->raw[]=$row2;
	}
