<?php 
	/****
		views	: Phr/data/farmasiProduct_data
...
$id=dbIdReport('id','farmasi_product list',json_encode($get)); 
...
if($get['_search']==='false'){	
	...
	$SQL = "SELECT prod_id id  FROM ".$this->$module->table." a  
	ORDER BY $sidx $sord 
	LIMIT $start , $limit"; 
