...
jQuery("#list").jqGrid({
   	url:dataUrl1,
	datatype: "json",
   	colNames:[ 'Nama','Permision', 'Judul','Pos','Sub Menu'],
   	colModel:[
//   		{name:'id',index:'menu_id', width:55, align:"right"},
   		{name:'name',index:'menu_name', width:150},
		{name:'permision',sortable:false,width:159,align:"center"},
   		{name:'title',index:'menu_title', width:250},
   		{name:'pos',index:'menu_position', width:66,align:"center"},
   		{name:'total',sortable:false,width:99,align:"center"},		
   	],
   	rowNum:15,
   	rowList:[15,25,40],
   	pager: '#pager',
...
jQuery("#list2").jqGrid({
   	url:dataUrl2,
	datatype: "json",
   	colNames:[ 'Nama','Permision', 'Judul','Pos'],
   	colModel:[
//   		{name:'id',index:'menu_id', width:55},
   		{name:'name',index:'menu_name', width:150},
		{name:'permision',sortable:false,width:199,align:"center"},
   		{name:'title',index:'menu_title', width:250},
		{name:'pos',index:'menu_position', width:66,align:"center"},
