...
public $param; 
private $folder='belajar'; 
/***
Controller:	belajar
Function:	jqgrid2c
***/ 
	public function jqgrid2c()
	{
		$this->param['breadcrumbs']=array('belajar','jqgrid');
 
		$mainPage=$this->uri->segment(1).'Jqgrid2c';
		$this->param['contents']=array( $mainPage,'mycode' ); 
		$this->param['title']='[ERP]belajar::jqgrid::load';
		 	
		$this->param['files'][]=array( 
		   'name'=>'Main View',
		   'source'=>$this->folder."/".$mainPage."_view", 
		);
		
		$this->param['filesjs']=array( 
			array(
				'name'=>'Json JS',
				'source'=>$this->folder."/".$this->uri->segment(1).'Jqgrid2c'.".js"
			) 
		);
		$this->param['myUrl']=$this->uri->segment(1).'Jqgrid1';
...
Function:	jqgrid2b
***/ 
	public function jqgrid2b()
	{
		$this->param['breadcrumbs']=array('belajar','jqgrid');
 
		$mainPage=$this->uri->segment(1).'Jqgrid2b';
		$this->param['contents']=array( $mainPage,'mycode' ); 
		$this->param['title']='[ERP]belajar::jqgrid::load';
		...
		$this->param['filesjs']=array( 
			array(
				'name'=>'Json JS',
				'source'=>$this->folder."/".$this->uri->segment(1).'Jqgrid2b'.".js"
			) 
		);
		$this->param['myUrl']=$this->uri->segment(1).'Jqgrid1';
...
Function:	jqgrid2a
***/ 
	public function jqgrid2a()
	{
		$this->param['breadcrumbs']=array('belajar','jqgrid');
 
		$mainPage=$this->uri->segment(1).'Jqgrid2';
		$this->param['contents']=array( $mainPage,'mycode' ); 
		$this->param['title']='[ERP]belajar::jqgrid::load';
		...
		$this->param['filesjs']=array( 
			array(
				'name'=>'Json JS',
				'source'=>$this->folder."/".$this->uri->segment(1).'Jqgrid2a'.".js"
			) 
		);
		$this->param['myUrl']=$this->uri->segment(1).'Jqgrid1';
...
***/ 
	public function jqgrid1()
	{
		...
		$mainPage=$this->uri->segment(1).'Jqgrid1';
		$this->param['contents']=array( $mainPage,'mycode' ); 
		$this->param['title']='[ERP]belajar::jqgrid::load';
		$jsScript=$this->param['folder'].$this->uri->segment(1).'Jqgrid1'."sub.js";
		...
		$this->param['filesjs']=array( 
			array(
				'name'=>'Json JS',
				'source'=>$this->folder."/".$this->uri->segment(1).'Jqgrid1'.".js"
			),
			array(
				'name'=>'Array JS',
				'source'=>$this->folder."/".$this->uri->segment(1).'Jqgrid1'."sub.js"
			)
		);
 
		$this->showView();  
		$folder=$this->param['folder']; 
		$this->checkView($folder."data/belajarJqgrid1_data");
