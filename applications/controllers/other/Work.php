...
***/ 
	...
	{ 
		$this->param['breadcrumbs']=array('work','job list'); 
		$mainPage=$this->uri->segment(1).'Jobs';
		$this->param['contents']=array( $mainPage );
		$this->param['title']='ERP::Job List';
		$this->param['module']='job';
/*
model: jobs_model
view:workJobs_view
js: {folder}/workJobs.js
*/
		$this->showView(); 
/*
form : workJobsEditForm_view, workJobsAddForm_view
data: workJobsSave_data, workJobs_data
*/		
		$folder=$this->param['folder'];
		$this->checkView($folder."workJobsEditForm_view");
		$this->checkView($folder."workJobsAddForm_view");
		$this->checkView($folder."data/workJobsSave_data");
		$this->checkView($folder."data/workJobs_data");
