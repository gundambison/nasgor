...
*/
	...
	{
		dbIdReport('update','update Gundam',json_encode($data), 4000);
...
*/
	...
	{
		$id=$data['gun_id']=dbIdReport('id','create Gundam',json_encode($data),4000);
